  ...
  return (
    <div id='portfolio' className='text-center'>
      ...
      <Modal isOpen={hos} onRequestClose={()=>sethos(false)}
                      ...
                      <br/>
                      <h4>SVA Corporation is poised to enter into hospitality industry which is being focused mainly into Catering Business which as diversification such as Marriage Parties/Buffet Lunch and Dinners/Healthy &amp Nutritious Snacks/Birthday Parties/Family Get Together/Reunion of Schools and Colleges etc</h4>
                      
                      <h4>SVA Corporation arranges to despatch Diwali Sweets from Mumbai/Goa in any country across globe within record time and has been instrumental in developing the export of few Indian Fruits Industry</h4>
      </Modal>
...
style={{overlay:{background:'grey',marginTop:'35px'},content:{marginTop:'50px'}}}>
        ...
        <div className='row'>
          <div className='portfolio-items'>
            <div className='col-sm-6 col-md-4 col-lg-4' onClick={()=>setModalIsOpen(true)}>
                ...
                <div className='hover-bg' >
                  ...
                  >
                    ...
                    <div className='hover-text' >
                      <h4>''Design creates culture. Culture shapes values. Values determine the future." -Robert L. Peters.</h4>
                    </div>
                    <img
            ...
            <div className='col-sm-6 col-md-4 col-lg-4'>
              <div className='portfolio-item'>
                <div className='hover-bg' onClick={()=>sethos(true)}>
                  ...
                  >
                    <div className='hover-text'>
                      <h4>"Hospitality is not to change people, but to offer them space where change can take place." - Henri Nouwen.</h4>
                    </div>
                    <img
            ...
            <div className='col-sm-6 col-md-4 col-lg-4'>
              <div className='portfolio-item'>
                <div className='hover-bg' onClick={()=>setMana(true)}>
                  ...
                  >
                    <div className='hover-text'>
                      <h4>"Management is all about managing in the short term, while developing the plans for the long term."- Jack Welch.</h4>
                    </div>
                    <img
            ...
            <div className='col-sm-6 col-md-4 col-lg-4'>
              <div className='portfolio-item'>
                <div className='hover-bg' onClick={()=>setAgri(true)}>
                  ...
                  >
                    <div className='hover-text'>
                      <h4>"Agriculture is not a Farming, it's a Feeding"- Reddy Sai </h4>
                    </div>
                    <img
            ...
            <div className='col-sm-6 col-md-4 col-lg-4'>
              <div className='portfolio-item'>
                <div className='hover-bg' onClick={()=>setInsu(true)}>
                  ...
                  >
                    <div className='hover-text'>
                      <h4>"You don't need to pray to God any more when there are storms in the sky, but you do have to be insured" - Bertolt Brecht</h4>
                    </div>
                    <img
            ...
            <div className='col-sm-6 col-md-4 col-lg-4'>
              <div className='portfolio-item'>
                <div className='hover-bg' onClick={()=>setEdu(true)}>
                  ...
                  >
                    <div className='hover-text'>
                      <h4>"Education is not the learning of facts, but the training of the mind to think." - Albert Einstein.</h4>
                    </div>
                    <img
